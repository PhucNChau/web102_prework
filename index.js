...
const descriptionString = `
    <p>A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length} games. Currently, ${numberOfUnfundedGames} game${numberOfUnfundedGames > 1 ? "s" : ""} remain${numberOfUnfundedGames > 1 ? "" : "s"} unfunded. We need your help to fund these amazing games!</p>
`;
...
const moveTopButton = document.getElementById('moveTopBtn');
